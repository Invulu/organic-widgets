...
wp.organicProfileWidget = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.organicProfileWidget.OrganicProfileWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicProfileWidget.id_base !== idBase ) {
			return;
		}
	 ...
	 * attached which calls wp.organicProfileWidget.init().
	 *
	 * @returns {void}
	 */
