...
class Organic_Widgets_Profile_Widget extends Organic_Widgets_Custom_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php if ( '' != $title || '' != $text || '' != $subtitle ) { ?>
				...
				<div class="organic-widgets-section organic_widgets-profile-section<?php if ( $first_last ) { echo esc_attr( $first_last ); } ?>" <?php if ($instance['bg_color']) { ?>style="background-color:<?php echo $instance['bg_color']; ?>;"<?php } ?>>
