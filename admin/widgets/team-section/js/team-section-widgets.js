...
wp.organicTeamSectionWidgets = ( function( $ ) {
	'use strict';
	 ...
	 * Text widget control.
	 *
	 * @class OrganicTeamSectionWidgetControl
	 * @constructor
	 * @abstract
	 */
	component.OrganicTeamSectionWidgetControl = Backbone.View.extend({
      ...
      control.fieldContainer.html( wp.template( 'widget-organic_widgets_team_section-control-fields' ) );
	...
	/**
	 * Mapping of widget ID to instances of OrganicTeamSectionWidgetControl subclasses.
	 *
	 * @type {Object.<string, wp.featuredContentWidgets.OrganicTeamSectionWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( 'organic_widgets_team_section' !== idBase ) {
			return;
		}
    ...
    if ( component.widgetControls[ widgetId ] ) {
		...
		widgetControl = new component.OrganicTeamSectionWidgetControl({
			el: widgetContainer
		});
