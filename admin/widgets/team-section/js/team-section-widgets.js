...
wp.organicTeamSectionWidget = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.organicTeamSectionWidget.OrganicTeamSectionWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicTeamSectionWidget.id_base !== idBase ) {
			return;
		}
	 ...
	 * attached which calls wp.organicTeamSectionWidget.init().
	 *
	 * @returns {void}
	 */
