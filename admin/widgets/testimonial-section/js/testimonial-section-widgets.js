...
wp.organicTestimonialSectionWidgets = ( function( $ ) {
	'use strict';
	 ...
	 * Text widget control.
	 *
	 * @class OrganicTestimonialSectionWidgetControl
	 * @constructor
	 * @abstract
	 */
	component.OrganicTestimonialSectionWidgetControl = Backbone.View.extend({
      ...
      control.fieldContainer.html( wp.template( 'widget-organic_widgets_testimonial_section-control-fields' ) );
	...
	/**
	 * Mapping of widget ID to instances of OrganicTestimonialSectionWidgetControl subclasses.
	 *
	 * @type {Object.<string, wp.featuredContentWidgets.OrganicTestimonialSectionWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( 'organic_widgets_testimonial_section' !== idBase ) {
			return;
		}
    ...
    if ( component.widgetControls[ widgetId ] ) {
		...
		widgetControl = new component.OrganicTestimonialSectionWidgetControl({
			el: widgetContainer
		});
