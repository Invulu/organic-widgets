...
wp.organicTestimonialSectionWidget = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.organicTestimonialSectionWidget.OrganicTestimonialSectionWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicTestimonialSectionWidget.id_base !== idBase ) {
			return;
		}
	 ...
	 * attached which calls wp.organicTestimonialSectionWidget.init().
	 *
	 * @returns {void}
	 */
