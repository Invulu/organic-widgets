...
wp.organicFeaturedContentWidget = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.organicFeaturedContentWidget.organicFeaturedContentWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicFeaturedContentWidget.id_base !== idBase ) {
			return;
		}
	 ...
	 * attached which calls wp.organicFeaturedContentWidget.init().
	 *
	 * @returns {void}
	 */
