...
wp.organicBlogPostsSectionWidget = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.organicBlogPostsSectionWidget.OrganicBlogPostsSectionWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicBlogPostsSectionWidget.id_base !== idBase ) {
			return;
		}
	 ...
	 * attached which calls wp.organicBlogPostsSectionWidget.init().
	 *
	 * @returns {void}
	 */
