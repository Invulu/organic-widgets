...
wp.organicPricingTableWidget = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.organicPricingTableWidget.OrganicPricingTableWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicPricingTableWidget.id_base !== idBase ) {
			return;
		}
	 ...
	 * attached which calls wp.organicPricingTableWidget.init().
	 *
	 * @returns {void}
	 */
