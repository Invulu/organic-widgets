...
wp.organicPortfolioSectionWidget = ( function( $ ) {
	'use strict';
	 ...
	 * Text widget control.
	 *
	 * @class OrganicPortfolioSectionWidgetControl
	 * @constructor
	 * @abstract
	 */
	component.OrganicPortfolioSectionWidgetControl = Backbone.View.extend({
	...
	/**
	 * Mapping of widget ID to instances of OrganicPortfolioSectionWidgetControl subclasses.
	 *
	 * @type {Object.<string, wp.organicPortfolioSectionWidget.OrganicPortfolioSectionWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicPortfolioSectionWidget.id_base !== idBase ) {
			return;
		}
		...
		widgetControl = new component.OrganicPortfolioSectionWidgetControl({
			el: fieldContainer,
	 ...
	 * attached which calls wp.organicPortfolioSectionWidget.init().
	 *
	 * @returns {void}
	 */
