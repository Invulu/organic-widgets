...
wp.organicFeaturedProductWidget = ( function( $ ) {
	'use strict';
	 ...
	 * Text widget control.
	 *
	 * @class OrganicFeaturedProductWidgetControl
	 * @constructor
	 * @abstract
	 */
	component.OrganicFeaturedProductWidgetControl = Backbone.View.extend({
	...
	/**
	 * Mapping of widget ID to instances of OrganicFeaturedProductWidgetControl subclasses.
	 *
	 * @type {Object.<string, wp.organicFeaturedProductWidget.OrganicFeaturedProductWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicFeaturedProductWidget.id_base !== idBase ) {
			return;
		}
		...
		widgetControl = new component.OrganicFeaturedProductWidgetControl({
			el: fieldContainer,
	 ...
	 * attached which calls wp.organicFeaturedProductWidget.init().
	 *
	 * @returns {void}
	 */
