...
wp.organicSubpageWidgets = ( function( $ ) {
	'use strict';
	 ...
	 * Text widget control.
	 *
	 * @class OrganicSubpageWidgetControl
	 * @constructor
	 * @abstract
	 */
	component.OrganicSubpageWidgetControl = Backbone.View.extend({
      ...
      control.fieldContainer.html( wp.template( 'widget-organic_widgets_subpage_section-control-fields' ) );
	...
	/**
	 * Mapping of widget ID to instances of OrganicSubpageWidgetControl subclasses.
	 *
	 * @type {Object.<string, wp.featuredContentWidgets.OrganicSubpageWidgetControl>}
	 */
    ...
    if ( component.widgetControls[ widgetId ] ) {
		...
		widgetControl = new component.OrganicSubpageWidgetControl({
			el: widgetContainer
		});
