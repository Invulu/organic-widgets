...
wp.organicSubpageWidget = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.organicSubpageWidget.OrganicSubpageWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicSubpageWidget.id_base !== idBase ) {
			return;
		}
	 ...
	 * attached which calls wp.organicSubpageWidget.init().
	 *
	 * @returns {void}
	 */
