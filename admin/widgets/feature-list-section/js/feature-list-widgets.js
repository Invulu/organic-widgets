...
wp.organicFeatureListWidgets = ( function( $ ) {
	'use strict';
	 ...
	 *
	 * @type {Object.<string, wp.featuredContentWidgets.OrganicFeatureListWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( 'organic_widgets_feature_list_section' !== idBase ) {
			return;
		}
