...
wp.organicFeatureListWidget = ( function( $ ) {
	'use strict';
	 ...
	 * Text widget control.
	 *
	 * @class OrganicFeatureListWidgetControl
	 * @constructor
	 * @abstract
	 */
	component.OrganicFeatureListWidgetControl = Backbone.View.extend({
	...
	/**
	 * Mapping of widget ID to instances of OrganicFeatureListWidgetControl subclasses.
	 *
	 * @type {Object.<string, wp.organicFeatureListWidget.OrganicFeatureListWidgetControl>}
	 */
	...
	component.handleWidgetAdded = function handleWidgetAdded( event, widgetContainer ) {
		...
		if ( OrganicFeatureListWidget.id_base !== idBase ) {
			return;
		}
		...
		widgetControl = new component.OrganicFeatureListWidgetControl({
			el: fieldContainer,
	 ...
	 * attached which calls wp.organicFeatureListWidget.init().
	 *
	 * @returns {void}
	 */
