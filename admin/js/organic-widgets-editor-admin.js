(function( $ ) {
	...
	function hideEditor() {
		...
		var customizeButton = '<a href="'+organicWidgets.customizeURL+'" class="button button-primary button-large organic-widgets-customize-page-button '+buttonSize+'" '+customizeDisabled+'>Customize Page</a>';
