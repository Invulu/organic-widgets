...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataJs = __webpack_require__(189);
	...
	wp.blocks.registerBlockType('organic-widgets/content-slideshow', {
		...
		edit: (function (_wp$element$Component) {
			...
			function edit() {
				...
				var poststoshow = this.props.attributes.poststoshow;
	
				this.state = {
					contentSlideshow: []
				};
	
				this.contentSlideshowRequest = (0, _dataJs.getContentSlideshow)(poststoshow);
	
				this.contentSlideshowRequest.then(function (contentSlideshow) {
					return _this.setState({ contentSlideshow: contentSlideshow });
				});
			}
			...
			_createClass(edit, [{
				...
				value: function render() {
					var contentSlideshow = this.state.contentSlideshow;
	
					if (!contentSlideshow.length) {
						return React.createElement(wp.components.Placeholder, {
							icon: 'update',
					...
					return React.createElement(
						'div',
						{ className: 'blocks-latest-posts' },
						React.createElement(
							'ul',
							null,
							contentSlideshow.map(function (post, i) {
								return React.createElement(
									'li',
									{ key: i },
									React.createElement(
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(173)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports) {
	...
	exports.getContentSlideshow = getContentSlideshow;
	
	function getContentSlideshow() {
		var postsToShow = arguments.length <= 0 || arguments[0] === undefined ? 6 : arguments[0];
